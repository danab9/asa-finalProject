...
- **Lineage database**: A BUSCO database can be provided as a file (with offilne parameter set to 'True', or as a name to be searched by the program online. For available databases see BUSCO's manual [here]{https://busco.ezlab.org/busco_userguide.html}.
